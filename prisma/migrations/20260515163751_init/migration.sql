...
-- CreateTable
CREATE TABLE "ShiftCut" (
    "id" SERIAL NOT NULL,
    "shiftAssignmentId" INTEGER NOT NULL,
    "cutTime" TIMESTAMP(3) NOT NULL,
    "reason" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ShiftCut_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ShiftCut" ADD CONSTRAINT "ShiftCut_shiftAssignmentId_fkey" FOREIGN KEY ("shiftAssignmentId") REFERENCES "ShiftAssignment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
